...
/// <summary>
/// Identifies a group of related business work independently from distributed tracing.
/// </summary>
public readonly record struct CorrelationId
{
    ...
    /// <summary>
    /// Parses a canonical hyphenated GUID into a correlation ID.
    /// </summary>
    /// <param name="value">A canonical <c>D</c>-format GUID.</param>
    /// <returns>The parsed correlation ID.</returns>
    ...
    public static CorrelationId Parse(string value)
    {
        ...
        return TryParse(value, out var result)
            ? result
            : throw new FormatException("The value is not a canonical non-empty correlation ID.");
    }

    /// <summary>
    /// Attempts to parse a canonical hyphenated GUID into a correlation ID.
    /// </summary>
    /// <param name="value">A canonical <c>D</c>-format GUID.</param>
